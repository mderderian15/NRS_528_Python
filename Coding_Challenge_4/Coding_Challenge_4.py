...
in_features = r'C:\NRS 528\BIO_Natural_Heritage_Areas_2023.shp'
erase_features = r'C:\NRS 528\North_Kingstown_Boundary.shp'
out_feature_class = r'C:\NRS 528\BIO_Natural_Heritage_Areas_2023_Erase.shp'
