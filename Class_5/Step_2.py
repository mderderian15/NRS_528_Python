...
arcpy.env.workspace = r"C:\NRS 528\NRS_528_Python\pythonProject\Class_5\Step_2_Deep_Coral_Data"
# workspace command must go to a folder not a file
# make sure to put the right path when creating the workspace and not using the example
...
originCoordinate = "-176.87 -51"  # Left bottom of our point data # first value is longitude (x)
