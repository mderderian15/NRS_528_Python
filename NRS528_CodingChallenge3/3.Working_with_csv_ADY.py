...
#AD moved these to before the loop
spring_list = []
summer_list = []
autumn_list = []
winter_list = []
...
with open("co2_ppm_daily.csv") as co2_csv:
    ...
    for row in csv.reader(co2_csv):
        ...
        #AD not sure what you are doing here, so I commnted out these two lines
        # if month not in date_list:
        #     date_list.append(month)

        #AD need to correct your months as they look like 01, 02, 03 etc in the data file
