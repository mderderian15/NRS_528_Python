...
import arcpy
arcpy.env.workspace = r'C:\NRS 528\NRS_528_Python\NRS528_Coding_Challenge_5'
...
in_data1 = 'Step_3_Cepphus_Grylle_Output.shp'
in_data2 = 'Step_3_Fishnet.shp'
arcpy.Delete_management(in_data1)
arcpy.Delete_management(in_data2)

# 6. Visualize in ArcGIS Pro

# Hint: To stop your script failing due to unable to overwriteOutput error, use the overwriteOutput environment
# setting: import arcpy arcpy.env.overwriteOutput = True
# If you get "already exists error" even when True,
# ensure file is not open in # ArcGIS Pro or another program such as Excel.
